    ...
    <div class="app">
        ...
        <div class="content-center">
            <SettingsCard :photoUrl="photoUrl" :enableEditing="true" :photoChanged="photoChanged" :text="text"
                title="Group name" submitButtonText="Create group" :loading="loading" @uploadPhoto="uploadPhoto"
                @revertPhoto="revertPhoto" @deletePhoto="deletePhoto" @keyPress="setText" @submit="createGroup" />
