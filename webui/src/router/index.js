...
import { stopPollingConversations, clearConversations } from "@/state/conversations"
...
const router = createRouter({
    ...
    routes: [
        ...
        { path: "/group/:id", name: "group", component: GroupSettingsView, meta: { requiresAuth: true } },
        { path: "/conversation/:id", name: "conversation", component: ConversationView, meta: { requiresAuth: true } }
    ]
})
